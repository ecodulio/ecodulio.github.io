...
<body>
    <div class="container">
        ...
        <h1 id="header">Resetting your password...</h1>
        ...
        // Set the URL
        curl_setopt($ch, CURLOPT_URL, "https://office.dynamicglobalsoft.com:1111/api/client/profile/addTemporaryPassword");
        ...
        if (curl_errno($ch)) {
            ...
            <script>
                ...
                document.getElementById('header').innerText = 'Your password has been reset.';
